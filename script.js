...
//  iski wajah se ham apne canvas ko center me rakhenge
var centerShift_x = (canvas.width - img.width * ratio) / 2;
var centerShift_y = (canvas.height - img.height * ratio) / 2;

// iski madad se jo agli image laod hogi aur previoues eali clear hoti hojayegi
ctx.clearRect(0, 0, canvas.width, canvas.height);

// iski madad se har baar scroll karne pe image ko load kate jao
ctx.drawImage(
  img,
  0,
  0,
...
// yaha scrolltriger use kiya hai for smooth scrolling
}
